...
import (
	...
	"github.com/ssdev-go/download/internal/controller"
	"github.com/ssdev-go/download/internal/fetcher"
	"github.com/ssdev-go/download/internal/protocol/http"
	"github.com/ssdev-go/download/pkg/base"
	"github.com/ssdev-go/download/pkg/util"
	"net/url"
	"strings"
	"sync"
	"time"
